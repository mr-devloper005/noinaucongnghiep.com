      ...
      <main className="px-3 py-5 sm:px-5 sm:py-8">
        <section className="mx-auto grid w-full max-w-[var(--editable-container)] overflow-hidden rounded-[2rem] border border-[var(--editable-border)] bg-[var(--slot4-surface-bg)] shadow-[0_24px_70px_rgba(11,26,77,0.10)] sm:rounded-[2.5rem] lg:grid-cols-2">
          ...
          <div className="relative order-first hidden flex-col justify-between overflow-hidden bg-[var(--slot4-ink)] p-12 text-[var(--slot4-on-ink)] lg:order-last lg:flex">
            <div className="pointer-events-none absolute -left-24 -top-24 h-72 w-72 rounded-full bg-[var(--slot4-lime)]/20 blur-[110px]" />
            ...
            <div className="relative">
              ...
              <h2 className="editable-display mt-4 text-4xl font-extrabold leading-[1.06] tracking-[-0.03em]">{copy.title}</h2>
